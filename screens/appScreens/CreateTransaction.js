...
function CreateTransaction({ setScreenToShow }) {
    ...
    return (
        <View style={styles.container}>
            {isModalVisible && <View style={styles.modalStyle}>

                <View style={styles.modalStyleInner}>
                    <View></View>
                    <Pressable onPress={toggleModal}>
                        <MaterialIcons name="cancel" size={win.width / 16} color="white" />
                    </Pressable>
                </View>
                <Image source={infoMod} />
                <Text style={styles.modalText}>There is no user registered with that email address</Text>
